    ...
    <section>
      ...
      <div className="cert-container">
        <div className="cert-card">
          <h3 className="border-b-8 border-black">
        ...
        <div className="cert-card">
          <h3 className="border-b-8 border-[#61DAFB]">
        ...
        <div className="cert-card">
          <h3 className="border-b-8 border-[#F7DF1E]">
        ...
        <div className="cert-card">
          <h3 className="border-b-8 border-[#5A29E4]">
        ...
        <div className="cert-card">
          <h3 className="border-b-8 border-[#46E3B7]">
        ...
        <div className="cert-card">
          <h3 className="border-b-8 border-[#1572B6]">
        ...
        <div className="cert-card">
          <h3 className="border-b-8 border-[#E34F26]">
